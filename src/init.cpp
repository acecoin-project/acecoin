...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9884 or testnet: 19884)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9883 or testnet: 19883)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Acecoin Wiki for SSL setup instructions)") + "\n" +
